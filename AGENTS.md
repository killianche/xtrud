...
Если ты в проекте впервые — сначала
[`docs/ONBOARDING_AGENT.md`](docs/ONBOARDING_AGENT.md): архитектура за минуту,
частые ошибки, требования к дизайну и порядок сдачи задачи.
