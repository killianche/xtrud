...
- **Категории:** 3 уровня. **L1 = 10**, **L2 = 64**, **L3 ≈ 290**.
...
##### L2 — Климат `climate` — `Wind`
- `ac-install` — Установка кондиционера | `Wind` | 5 000 ₽ | week
- `ac-service` — Заправка / чистка кондиционера | `Wind` | 3 000 ₽ | week
- `ventilation` — Монтаж вентиляции | `Wind` | 25 000 ₽ | month
