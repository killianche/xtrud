...
- FACT: копий базы xtrud на сервере не было — заведён `/opt/xtrud/backup.sh`
  ...
  `pg_restore --list`.
- FACT: в live-базе 4 пользователя, 0 специалистов, 6 заданий; статистика
  показывает удаление 63 пользователей и 26 профилей 2026-09-02…03 —
  причина не задокументирована (UNKNOWN, вопрос владельцу).
