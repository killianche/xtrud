/**
 * /profile/specialist — «Я специалист»: всё, что человек рассказывает о
 * себе как об исполнителе. DECISION владельца 2026-09-07: «отметить, чем
 * занимается (категории), написать о себе, поделиться фото работ, оставить
 * контакты (WhatsApp) — и всё; дальше — отзывы». Экран в стиле Настроек:
 * группы строк, каждая ведёт на свой вопрос. Видимость в каталоге считает
 * сервер: достаточно одной категории (0169).
 */
