# TASKS — историческая часть (май 2026)

> Извлечено из `TASKS.md` 2026-08-30. Это история спринтов мая 2026:
> приоритет 5 по `docs/AGENT_WORKFLOW.md` §1. Актуальный план — в корневом
> [`TASKS.md`](../TASKS.md).
