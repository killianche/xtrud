 ...
 * центре («Смотреть заказы») — тот
 * рисовался вручную, не был реальным Tabs.Screen, и требовал ручного mutex
 * (isSearchActive), чтобы «Заказы» не подсвечивались
 ...
 * псевдо-таб убран целиком. «Ваши работы» (портфолио)
...
// Порядок реальных таб-роутов в навбаре. `cases` в этот список
