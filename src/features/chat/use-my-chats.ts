...
// Pure-функции isChatUnread / unreadChatsCount вынесены в unread-helpers.ts
// чтобы unit-тесты в Node могли их использовать без RN-bundle.

import { useQuery } from "@tanstack/react-query";
import { supabase } from "@/lib/supabase";
import type { Tables } from "@/types/database";

export { isChatUnread, unreadChatsCount } from "./unread-helpers";
